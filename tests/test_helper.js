...
window.startApp          = require('rails-ember-cli/tests/helpers/start_app')['default'];
window.isolatedContainer = require('rails-ember-cli/tests/helpers/isolated_container')['default'];
